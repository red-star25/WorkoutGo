...
class PopularOnClicked extends StatelessWidget {
  final PopularExercise exerciseData;
  final int index;
  PopularOnClicked({this.exerciseData, this.index});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder<List<PopularExercise>>(
  ...
  exerciseNow(BuildContext context) async {
...
class Equipment extends StatelessWidget {
  ...
  final PopularExercise exerciseModel;
